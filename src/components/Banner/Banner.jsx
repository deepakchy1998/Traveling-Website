					...
					<div className="container">
						<div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
							...
							<div className="flex flex-col justify-center gap-6 sm:pt-0 lg:px-16">
								...
								>
									Explore the world with **Five Oceans Tour & Travel**, your
									trusted partner for amazing trips! We make travel simple and
									fun by offering flight bookings, comfortable hotel stays,
									reliable Wi-Fi, and tasty food options. Whether you're
									planning a relaxing holiday or an exciting adventure, we’re
									here to help you every step of the way. Let’s make your travel
